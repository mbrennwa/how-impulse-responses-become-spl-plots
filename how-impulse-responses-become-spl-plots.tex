...
This follows directly from the use of sine functions, which are themselves periodic.  
In other words, when representing the discrete time-domain data $p_i$ as a sum of sine waves, the discrete Fourier transform assumes that this pattern repeats indefinitely for $t < 0$ and $t > T$.  
...
Each bin represents one sine-wave component used to describe the signal.  
